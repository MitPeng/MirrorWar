...
function modifier_item_vladmir_custom_aura:IsHidden()
	return not IsValid(self:GetCaster()) or self:GetCaster():HasModifier("modifier_item_blade_of_the_vigil_aura") or self:GetCaster():HasModifier("modifier_item_holy_cape_custom_aura") 
end
...
function modifier_item_vladmir_custom_aura:GetModifierBaseDamageOutgoing_Percentage(params)
	if not IsValid(self:GetCaster()) or self:GetCaster():HasModifier("modifier_item_blade_of_the_vigil_aura") or self:GetCaster():HasModifier("modifier_item_holy_cape_custom_aura")  then
		return 0
	end
