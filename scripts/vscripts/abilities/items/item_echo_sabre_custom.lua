...
function modifier_item_echo_sabre_custom:OnAttackLanded(params)
	...
	if params.attacker == self:GetParent() and #demagicking_maul_table == 0 and echo_sabre_table[1] == self and not params.attacker:IsIllusion() and not params.attacker:AttackFilter(params.record, ATTACK_STATE_NOT_PROCESSPROCS) then
