...
function item_necronomicon_custom:IsRefreshable()
	return false
end
...
function item_necronomicon_2_custom:IsRefreshable()
	return false
end
...
function item_necronomicon_3_custom:IsRefreshable()
	return false
end
...
function item_necronomicon_4_custom:IsRefreshable()
	return false
end
...
function modifier_item_necronomicon_custom:GetModifierBonusStats_Strength(params)
	return self.bonus_strength
end
function modifier_item_necronomicon_custom:GetModifierMPRegenAmplify_Percentage(params)
