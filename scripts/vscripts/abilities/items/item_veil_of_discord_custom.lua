...
function modifier_item_veil_of_discord_custom:GetModifierBonusStats_Strength(params)
	return self.bonus_strength
end
function modifier_item_veil_of_discord_custom:GetModifierBonusStats_Agility(params)
