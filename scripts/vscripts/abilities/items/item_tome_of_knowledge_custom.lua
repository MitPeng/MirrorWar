...
function item_tome_of_knowledge_custom:IsRefreshable()
	return false
end
---------------------------------------------------------------------
...
function item_tome_of_knowledge_2_custom:IsRefreshable()
	return false
end
---------------------------------------------------------------------
...
function item_tome_of_knowledge_3_custom:IsRefreshable()
	return false
end
